...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideEffects(startEffects, authEffects, adminUsersEffects, frontendConfigEffects, fairgateTestEffects, orderEffects, navigationEffects, notificationEffects),
